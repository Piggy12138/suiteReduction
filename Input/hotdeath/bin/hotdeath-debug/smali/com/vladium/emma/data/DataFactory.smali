...
.method private static mergeload(Ljava/io/File;)[Lcom/vladium/emma/data/IMergeable;
    ...
    .line 397
    invoke-virtual {v10}, Lcom/vladium/logging/Logger;->atTRACE1()Z

    move-result v11

    .line 398
    invoke-virtual {v10}, Lcom/vladium/logging/Logger;->atTRACE2()Z

    move-result v12

    .line 399
    const-string v3, "mergeload"
    ...
    new-array v13, v5, [Lcom/vladium/emma/data/IMergeable;
    ...
    const-string v5, "input file does not exist: ["
    ...
    invoke-virtual {v10, v6, v7}, Lcom/vladium/logging/Logger;->trace1(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v6, "] is corrupt or was not created by "
    ...
    invoke-virtual {v10, v0, v1}, Lcom/vladium/logging/Logger;->trace2(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3
    ...
    const-string v9, "]: file processed in "
    ...
    invoke-virtual {v10, v7, v3}, Lcom/vladium/logging/Logger;->trace1(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v21, "]: found valid entry of size "
    ...
    invoke-static {v5, v0, v1, v2}, Lcom/vladium/emma/data/DataFactory;->readEntry(Ljava/io/RandomAccessFile;BJ)Lcom/vladium/emma/data/IMergeable;
    ...
    const-string v22, "entry read in "
...
.method private static persist(Lcom/vladium/emma/data/IMergeable;BLjava/io/File;)V
    ...
    .line 506
    invoke-virtual {v3}, Lcom/vladium/logging/Logger;->atTRACE1()Z
    ...
    const-string v6, "can persist in normal files only: "
    ...
    invoke-direct {v4, v0, v6}, Ljava/io/RandomAccessFile;-><init>(Ljava/io/File;Ljava/lang/String;)V
    :try_end_2
    ...
    const-string v8, "]: existing file length = "
    ...
    invoke-virtual {v3, v5, v6}, Lcom/vladium/logging/Logger;->trace1(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 669
    :cond_3
    invoke-static {v4}, Lcom/vladium/emma/data/DataFactory;->writeFileHeader(Ljava/io/DataOutput;)V
    ...
    invoke-static/range {v3 .. v8}, Lcom/vladium/emma/data/DataFactory;->writeEntry(Lcom/vladium/logging/Logger;Ljava/io/RandomAccessFile;JLcom/vladium/emma/data/IMergeable;B)V
    :try_end_3
    ...
    const-string v8, "]: file processed in "
    ...
    invoke-virtual {v3, v6, v4}, Lcom/vladium/logging/Logger;->trace1(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v6, "cannot overwrite ["
    ...
    const-string v6, "]: not created by "
    ...
    const-string v9, "cannot merge new data into ["
    ...
    const-string v9, "]: created by another "
    ...
    invoke-static {v7, v6, v5}, Lcom/vladium/emma/data/DataFactory;->makeAppVersion(III)Ljava/lang/String;
    ...
    const-string v6, "cannot merge new data into ["
    ...
    const-string v6, "]: created by another "
    ...
    invoke-virtual {v3, v8, v0}, Lcom/vladium/logging/Logger;->trace2(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v14, "]: adding entry at position "
    ...
    invoke-virtual {v3, v7, v8}, Lcom/vladium/logging/Logger;->trace2(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v19, "]: found valid entry of size "
    ...
    const-string v7, "]: creating a new file"
    ...
    invoke-virtual {v3, v4, v6}, Lcom/vladium/logging/Logger;->trace1(Ljava/lang/String;Ljava/lang/String;)V
