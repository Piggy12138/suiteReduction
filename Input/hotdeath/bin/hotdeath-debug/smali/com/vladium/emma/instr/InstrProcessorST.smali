...
.method protected _run(Lcom/vladium/util/IProperties;)V
    ...
    iput-wide v9, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_currentArchiveTS:J
    ...
    .line 753
    iget-object v7, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_mdata:Lcom/vladium/emma/data/IMetaData;

    invoke-virtual {v0}, Ljava/lang/Boolean;->booleanValue()Z

    move-result v8

    invoke-static {v7, v3, v8}, Lcom/vladium/emma/data/DataFactory;->persist(Lcom/vladium/emma/data/IMetaData;Ljava/io/File;Z)V
...
.method public final handleArchiveEnd(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-wide v1, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_currentArchiveTS:J
...
.method public final handleArchiveEntry(Ljava/util/jar/JarInputStream;Ljava/util/zip/ZipEntry;)V
    ...
    .line 153
    invoke-virtual {v4}, Lcom/vladium/logging/Logger;->atTRACE2()Z

    move-result v1

    if-eqz v1, :cond_0

    const-string v1, "handleArchiveEntry"
    ...
    invoke-virtual {v4, v1, v2}, Lcom/vladium/logging/Logger;->trace2(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v5, Lcom/vladium/emma/instr/InstrProcessor$OutMode;->OUT_MODE_FULLCOPY:Lcom/vladium/emma/instr/InstrProcessor$OutMode;
    ...
    .line 176
    iget-object v1, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_coverageFilter:Lcom/vladium/emma/filter/IInclExclFilter;

    if-eqz v1, :cond_2

    iget-object v1, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_coverageFilter:Lcom/vladium/emma/filter/IInclExclFilter;

    invoke-interface {v1, v2}, Lcom/vladium/emma/filter/IInclExclFilter;->included(Ljava/lang/String;)Z
    ...
    .line 188
    :try_start_0
    iget-object v3, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_outMode:Lcom/vladium/emma/instr/InstrProcessor$OutMode;

    sget-object v5, Lcom/vladium/emma/instr/InstrProcessor$OutMode;->OUT_MODE_COPY:Lcom/vladium/emma/instr/InstrProcessor$OutMode;
    ...
    invoke-virtual {p0, v1, v5, v3}, Lcom/vladium/emma/instr/InstrProcessorST;->getFullOutFile(Ljava/io/File;Ljava/io/File;Z)Ljava/io/File;

    move-result-object v1

    .line 196
    iget-object v3, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_mdata:Lcom/vladium/emma/data/IMetaData;

    invoke-static {v2}, Lcom/vladium/util/Descriptors;->javaNameToVMName(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-interface {v3, v2}, Lcom/vladium/emma/data/IMetaData;->hasDescriptor(Ljava/lang/String;)Z
    :try_end_0
    ...
    invoke-direct {v2, v1}, Lcom/vladium/emma/EMMARuntimeException;-><init>(Ljava/lang/Throwable;)V
    ...
    iget-wide v2, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_currentArchiveTS:J
    ...
    const-string v2, "] skipped: more recent than the source"
    ...
    invoke-virtual {v4, v1}, Lcom/vladium/logging/Logger;->verbose(Ljava/lang/String;)V
    :try_end_2
    ...
    iget v2, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_readpos:I

    invoke-static {v1, v2}, Lcom/vladium/jcd/parser/ClassDefParser;->parseClass([BI)Lcom/vladium/jcd/cls/ClassDef;

    move-result-object v2

    .line 223
    iget-object v1, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_visitor:Lcom/vladium/emma/instr/InstrVisitor;

    iget-object v3, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_outMode:Lcom/vladium/emma/instr/InstrProcessor$OutMode;

    sget-object v4, Lcom/vladium/emma/instr/InstrProcessor$OutMode;->OUT_MODE_OVERWRITE:Lcom/vladium/emma/instr/InstrProcessor$OutMode;
    ...
    iget-object v6, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_instrResult:Lcom/vladium/emma/instr/InstrVisitor$InstrResult;

    invoke-virtual/range {v1 .. v6}, Lcom/vladium/emma/instr/InstrVisitor;->process(Lcom/vladium/jcd/cls/ClassDef;ZZZLcom/vladium/emma/instr/InstrVisitor$InstrResult;)V

    .line 224
    iget-object v1, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_instrResult:Lcom/vladium/emma/instr/InstrVisitor$InstrResult;

    iget-boolean v1, v1, Lcom/vladium/emma/instr/InstrVisitor$InstrResult;->m_instrumented:Z

    if-eqz v1, :cond_e

    .line 228
    iget v1, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_classInstrs:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_classInstrs:I

    .line 232
    iget-object v1, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_mdata:Lcom/vladium/emma/data/IMetaData;

    iget-object v3, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_instrResult:Lcom/vladium/emma/instr/InstrVisitor$InstrResult;

    iget-object v3, v3, Lcom/vladium/emma/instr/InstrVisitor$InstrResult;->m_descriptor:Lcom/vladium/emma/data/ClassDescriptor;

    const/4 v4, 0x0

    invoke-interface {v1, v3, v4}, Lcom/vladium/emma/data/IMetaData;->add(Lcom/vladium/emma/data/ClassDescriptor;Z)Z
    ...
    invoke-static {v2, v1}, Lcom/vladium/jcd/compiler/ClassWriter;->writeClassTable(Lcom/vladium/jcd/cls/ClassDef;Ljava/io/OutputStream;)V

    .line 239
    if-eqz v7, :cond_d

    .line 243
    iget-wide v1, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_timeStamp:J
    ...
    .line 244
    new-instance v1, Lcom/vladium/emma/instr/InstrProcessorST$EntryWriteJob;

    iget-object v2, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_archiveOut:Ljava/util/jar/JarOutputStream;

    iget-object v3, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_baos:Lcom/vladium/util/ByteArrayOStream;
    ...
    invoke-direct {v1, v2, v3, v0, v4}, Lcom/vladium/emma/instr/InstrProcessorST$EntryWriteJob;-><init>(Ljava/util/zip/ZipOutputStream;[BLjava/util/zip/ZipEntry;Z)V

    invoke-direct {p0, v1}, Lcom/vladium/emma/instr/InstrProcessorST;->addJob(Lcom/vladium/emma/instr/InstrProcessorST$Job;)V
    :try_end_4
    ...
    .line 327
    iget v1, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_readpos:I
    ...
    .line 329
    iget v2, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_classCopies:I

    add-int/lit8 v2, v2, 0x1

    iput v2, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_classCopies:I

    .line 331
    iget-wide v2, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_timeStamp:J
    ...
    iget-object v3, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_archiveOut:Ljava/util/jar/JarOutputStream;

    const/4 v4, 0x1

    move-object/from16 v0, p2

    invoke-direct {v2, v3, v1, v0, v4}, Lcom/vladium/emma/instr/InstrProcessorST$EntryWriteJob;-><init>(Ljava/util/zip/ZipOutputStream;[BLjava/util/zip/ZipEntry;Z)V

    invoke-direct {p0, v2}, Lcom/vladium/emma/instr/InstrProcessorST;->addJob(Lcom/vladium/emma/instr/InstrProcessorST$Job;)V
    :try_end_6
    .catch Ljava/io/IOException; {:try_start_6 .. :try_end_6} :catch_2
    ...
    :cond_d
    :try_start_7
    new-instance v1, Lcom/vladium/emma/instr/InstrProcessorST$FileWriteJob;

    iget-object v2, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_baos:Lcom/vladium/util/ByteArrayOStream;

    invoke-virtual {v2}, Lcom/vladium/util/ByteArrayOStream;->copyByteArray()[B

    move-result-object v2

    const/4 v3, 0x1

    invoke-direct {v1, v9, v2, v3}, Lcom/vladium/emma/instr/InstrProcessorST$FileWriteJob;-><init>(Ljava/io/File;[BZ)V
...
.method public final handleFile(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-virtual {v0, v1, v3}, Lcom/vladium/logging/Logger;->trace2(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 410
    iget-object v4, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_outMode:Lcom/vladium/emma/instr/InstrProcessor$OutMode;
    ...
    .line 430
    iget-object v3, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_coverageFilter:Lcom/vladium/emma/filter/IInclExclFilter;

    if-eqz v3, :cond_1

    iget-object v3, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_coverageFilter:Lcom/vladium/emma/filter/IInclExclFilter;

    invoke-interface {v3, v1}, Lcom/vladium/emma/filter/IInclExclFilter;->included(Ljava/lang/String;)Z
    ...
    invoke-static {p1, v3}, Lcom/vladium/util/Files;->newFile(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {p0, p1, p2, v4}, Lcom/vladium/emma/instr/InstrProcessorST;->getFullOutFile(Ljava/io/File;Ljava/io/File;Z)Ljava/io/File;
    ...
    .line 445
    iget-object v4, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_mdata:Lcom/vladium/emma/data/IMetaData;

    invoke-static {v1}, Lcom/vladium/util/Descriptors;->javaNameToVMName(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-interface {v4, v1}, Lcom/vladium/emma/data/IMetaData;->hasDescriptor(Ljava/lang/String;)Z
    :try_end_0
    .catch Ljava/io/FileNotFoundException; {:try_start_0 .. :try_end_0} :catch_3
    ...
    const-string v2, "] skipped: more recent that the source file"
    ...
    :cond_7
    :try_start_4
    invoke-direct {p0, v3}, Lcom/vladium/emma/instr/InstrProcessorST;->readFile(Ljava/io/File;)V
    ...
    .line 471
    iget-object v0, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_visitor:Lcom/vladium/emma/instr/InstrVisitor;
    ...
    iget-object v5, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_instrResult:Lcom/vladium/emma/instr/InstrVisitor$InstrResult;
    ...
    .line 472
    iget-object v0, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_instrResult:Lcom/vladium/emma/instr/InstrVisitor$InstrResult;
    ...
    .line 476
    iget v0, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_classInstrs:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_classInstrs:I

    .line 484
    iget-object v0, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_mdata:Lcom/vladium/emma/data/IMetaData;

    iget-object v2, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_instrResult:Lcom/vladium/emma/instr/InstrVisitor$InstrResult;

    iget-object v2, v2, Lcom/vladium/emma/instr/InstrVisitor$InstrResult;->m_descriptor:Lcom/vladium/emma/data/ClassDescriptor;

    const/4 v3, 0x0

    invoke-interface {v0, v2, v3}, Lcom/vladium/emma/data/IMetaData;->add(Lcom/vladium/emma/data/ClassDescriptor;Z)Z

    .line 488
    iget-object v0, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_baos:Lcom/vladium/util/ByteArrayOStream;

    invoke-virtual {v0}, Lcom/vladium/util/ByteArrayOStream;->reset()V

    .line 489
    iget-object v0, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_baos:Lcom/vladium/util/ByteArrayOStream;

    invoke-static {v1, v0}, Lcom/vladium/jcd/compiler/ClassWriter;->writeClassTable(Lcom/vladium/jcd/cls/ClassDef;Ljava/io/OutputStream;)V
    ...
    invoke-direct {v1, v10, v0, v8}, Lcom/vladium/emma/instr/InstrProcessorST$FileWriteJob;-><init>(Ljava/io/File;[BZ)V
    ...
    .line 554
    invoke-direct {p0, v0}, Lcom/vladium/emma/instr/InstrProcessorST;->readFile(Ljava/io/File;)V

    .line 556
    iget v0, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_readpos:I
    ...
    .line 558
    iget v1, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_classCopies:I

    add-int/lit8 v1, v1, 0x1

    iput v1, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_classCopies:I
    ...
    invoke-direct {v2, v1, v0, v8}, Lcom/vladium/emma/instr/InstrProcessorST$FileWriteJob;-><init>(Ljava/io/File;[BZ)V
    ...
    iget v4, p0, Lcom/vladium/emma/instr/InstrProcessorST;->m_readpos:I
